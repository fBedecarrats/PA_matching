...
#| echo: false
#| warning: false
#| class-output: "sourceCode julia"

cat(readLines("PA_matching_asis/005 - covariate_matching.jl"), sep = "\n")
```
:::
...
```{r}
library(JuliaCall)
julia_setup(JULIA_HOME = "/usr/bin/julia")
julia_console()
julia_call("using", "ArchGDAL")
