...
(100*sum(df$GIS_AREA * df$cover_loss/100)/18)/1e6 # 1.71)/ instead of 1.53
```

The results of the comparisons are very close in relative terms. In absulte term the difference is 11.8% higher: 1.71 Mha in annual loss instead of 1.53.  
...
/!\ C'est calculé avec GIS area vs. pixels... étrange.
