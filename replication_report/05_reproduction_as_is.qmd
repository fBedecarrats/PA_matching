...
We find negligible differences with the descriptive statistics presented in the result section of the original study.
...
On our side, we find 18,728 matched protected area fitting the analysis criteria defined by the source code, covering 6,167,491 km2.

The original study reports: 
> "In absolute terms, the 18,171 PAs in our analysis had an average annual forest loss rate of ~1.53 Mha."
Our replication finds ~1.71 Mha of deforestatoin in the 18,728 analyzed.
...
```
The original study reports: 
> In our analysis, 28.7% of the PAs did not have any forest loss.

In our replication, we find that 27.9% of of the PAs did not have any forest loss.

Regarding the overall deforestation in PAs created before 2001, the original study reports:
> Overall, PAs reduced, but did not eliminate, deforestation; the median annual deforestation rate in control areas (0.54%; s.d. = 2.21%) was 4.97 times higher than within PAs (0.11% per year; s.d. = 2.45%)


In protected areas created between 2001 and 2017, annual cover cela passerait de 0.431% à 0.477%, soit une hausse de 0.045%
Dans les zones de contrôle, la déforestation annuelle passerait de 0.751% à 1.032%, soit une hausse de 
```
> # paper text
...
> round(100*tapply(df_small$value, list(df_small$variable, df_small$Continent), mean),3)
                Oceania North America Europe  Asia Africa Lower GDP Higher GDP
Control areas     0.065         0.003  0.597 0.273  0.818     0.235      0.291
Protected areas   0.214        -0.081  0.154 0.130  0.293     0.148      0.024
```
