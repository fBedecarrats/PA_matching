...
gee_task <- ee_as_raster(image = combined, 
...
# Rasters fetched by Wolf et al. from other sources but present on GEE ---------
...
carbon <- ee$image("NASA/ORNL/biomass_carbon_density/v1")$
  select("agb")
land <- ee$image()
