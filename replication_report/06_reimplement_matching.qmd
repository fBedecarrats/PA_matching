...
lossyear <- gfc$select("lossyear")$
  updateMask(lossyear$neq(0))$ # maskout 0
...
combined_bands <- cover$addBands(c(lossyear, loss, elev, travel_time, pop_dens))

combined_bands <- combined_bands$rename(c("cover", "lossyear", "loss", "elev",
...
gee_rast <- ee_drive_to_local(ee_id = gee_task, dsn = "data_input/combined.tif")
