...
task_reg_9 <- ee_as_raster(
    aoi_image9, via = "drive", container = "rgee_test2", lazy = TRUE,
    dsn = "temp/MDG-6_9bands.tif", skipEmptyTiles = TRUE, scale = 1000)
...
mdg_files <- list.files(path = "temp", pattern = "MDG-6.*", full.names = TRUE)
MDG_6 <- rast(mdg_files[1])
