...
# aoi_image8 <- aoi_image7$addBands(
#   wdpa_reg$reduceToImage(properties = list("WDPAID"),
#                          reducer = ee$Reducer$first()))$toInt()
# wdpa_buffer <- wdpa_reg$geometry()$buffer(10000)
# wdpa_buffer <- ee$Feature(wdpa_buffer)$set("PA_buffer", 1)
# wdpa_yr <- wdpa$
#   filter(ee$Filter$notNull(list("STATUS_YR")))$
#   reduceToImage(properties = list("STATUS_YR"), reducer = ee$Reducer$first())
...
# Alltogether (without WDPA)
task_reg_9 <- ee_as_raster(
    aoi_image9, via = "drive", container = "rgee_test3", lazy = TRUE,
    dsn = "temp/MDG-6_9b_focus.tif", skipEmptyTiles = TRUE, scale = 1000,
    region = ee_region$geometry())
ee_utils_future_value(task_reg_9)

task_reg_9_proj <- ee_as_raster(
    aoi_image9, via = "drive", container = "rgee_test4", lazy = TRUE,
    dsn = "temp/MDG-6_9b_focus_proj.tif", skipEmptyTiles = TRUE, scale = 1000,
    region = ee_region$geometry(), crs = "EPSG:54017")
ee_utils_future_value(task_reg_9_proj)
...
task_reg_cover <- ee_as_raster(
    aoi_image, via = "drive", container = "rgee_test1", lazy = TRUE,
    dsn = "temp/MDG-6_cover.tif", skipEmptyTiles = TRUE, scale = 1000)
ee_utils_future_value(task_reg_cover)
# Really with cover
task_reg_coverOK <- ee_as_raster(
    aoi_cover, via = "drive", container = "rgee_test1", lazy = TRUE,
    dsn = "temp/MDG-6_cover.tif", skipEmptyTiles = TRUE, scale = 1000)
ee_utils_future_value(task_reg_coverOK)
# With slope 
task_reg_slope<- ee_as_raster(
    aoi_image, via = "drive", container = "rgee_test1", lazy = TRUE,
    dsn = "temp/MDG-6_w_terrain.tif", skipEmptyTiles = TRUE, scale = 1000)
ee_utils_future_value(task_reg_cover)
